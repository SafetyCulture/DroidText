...
public class Chunk implements Element
{
	 ...
	 * text invisible.
	 *
	 * @param mode        the text rendering mode. It can be <CODE>
	 ...
	 * @param strokeWidth the stroke line width for the modes <CODE>
	 *                    PdfContentByte.TEXT_RENDER_MODE_STROKE</CODE> and <CODE>
	 *                    PdfContentByte.TEXT_RENDER_MODE_FILL_STROKE</CODE>.
	 * @param strokeColor the stroke color or <CODE>null</CODE> to follow the text
	 *                    color
	 * @return this <CODE>Chunk</CODE>
	 */
