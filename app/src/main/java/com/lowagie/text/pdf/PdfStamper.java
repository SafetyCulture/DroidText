...
public class PdfStamper implements PdfViewerPreferences, PdfEncryptionSettings
{
	 ...
	 * @param reader     the original document. It cannot be reused
	 * @param os         the output stream
	 * @param pdfVersion the new pdf version or '\0' to keep the same version as the
	 *                   original document
	 * @throws DocumentException on error
	 * @throws IOException       on error
	 */
	 ...
	 * @param pdfVersion the new pdf version or '\0' to keep the same version as the
	 *                   original document
	 * @param append     if <CODE>true</CODE> appends the document changes as a new
	 ...
	 * same page.
	 *
	 * @param r            the <CODE>PdfReader</CODE> from where the new page will be
	 *                     imported
	 ...
	 * @param strength128Bits <code>true</code> for 128 bit key length, <code>false</code>
	 ...
	 * and AllowDegradedPrinting. The permissions can be combined by ORing them.
	 *
	 * @param strength      <code>true</code> for 128 bit key length, <code>false</code>
	 *                      for 40 bit key length
	 * @param userPassword  the user password. Can be null or empty
	 * @param ownerPassword the owner password. Can be null or empty
	 * @param permissions   the user permissions
	 ...
	 *
	 * @param flat <CODE>true</CODE> to flatten the fields, <CODE>false</CODE> to
	 *             keep the fields
	 */
	 ...
	 *
	 * @param flat <CODE>true</CODE> to flatten the FreeText annotations,
	 ...
	 * @param fileStore   an array with the file. If it's <CODE>null</CODE> the file
	 ...
	 *
	 * @param seconds the number of seconds to display the page. A negative value
	 *                removes the entry
	 * @param page    the page where the duration will be applied. The first page is
	 *                1
	 */
	 ...
	 *
	 * @param transition the transition object. A <code>null</code> removes the
	 *                   transition
	 * @param page       the page where the transition will be applied. The first page
	 *                   is 1
	 */
	 ...
	 * @param os         the output stream or <CODE>null</CODE> to keep the document in
	 *                   the temporary file
	 * @param pdfVersion the new pdf version or '\0' to keep the same version as the
	 *                   original document
	 * @param tempFile   location of the temporary file. If it's a directory a
	 ...
	 *                   will be used
	 * @param append     if <CODE>true</CODE> the signature and all the other content
