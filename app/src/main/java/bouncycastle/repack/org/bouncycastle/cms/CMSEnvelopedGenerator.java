...
public class CMSEnvelopedGenerator
{
	 ...
	 * @throws NoSuchProviderException  if the specified provider cannot be found
	 * @throws NoSuchAlgorithmException if the algorithm requested cannot be found
	 * @throws InvalidKeyException      if the keys are inappropriate for the algorithm specified
