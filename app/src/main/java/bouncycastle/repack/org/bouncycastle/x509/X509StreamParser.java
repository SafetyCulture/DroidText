		...
		implements StreamParser
{
	 ...
	 *
	 * @param type The name of the requested X.509 object type.
	 * @return a StreamParser object for the specified type.
	 * @throws NoSuchParserException if the requested type is not available in the default
	 ...
	 * @throws NoSuchProviderException if the provider can not be found.
	 * @see Provider
	 */
