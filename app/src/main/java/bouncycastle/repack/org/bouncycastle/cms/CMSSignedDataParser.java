		...
		extends CMSContentInfoParser
{
	 ...
	 * @throws NoSuchProviderException                           if the provider requested isn't available.
	 * @throws repack.org.bouncycastle.x509.NoSuchStoreException if the store type isn't available.
	 * @throws CMSException                                      if a general exception prevents creation of the X509Store
	 */
	 ...
	 * @throws NoSuchProviderException if the provider requested isn't available.
	 * @throws NoSuchStoreException    if the store type isn't available.
	 * @throws CMSException            if a general exception prevents creation of the X509Store
	 ...
	 *
	 * @throws NoSuchProviderException  if the provider requested isn't available.
	 * @throws NoSuchAlgorithmException if the cert store isn't available.
	 * @throws CMSException             if a general exception prevents creation of the CertStore
	 * @deprecated use getCertificates()
	 */
